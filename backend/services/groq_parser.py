...
FALLBACK_MODELS = list(dict.fromkeys([GROQ_MODEL, 'openai/gpt-oss-20b', 'groq/compound-mini', 'openai/gpt-oss-120b']))
    ...
    for model_name in FALLBACK_MODELS:
        for attempt in range(3):
            try:
                ...
                last_error = e
                logger.warning(f"Groq 429 rate limit on model {model_name}, attempt {attempt+1}/3: {e}")

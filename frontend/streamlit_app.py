    ...
    if st.session_state.access_token:
        ...
        if "error" in oauth:
            ...
            google_html = f"""<a href="{oauth['url']}" target="_self" style="
                ...
                margin-top:4px; box-sizing:border-box; box-shadow: 0 1px 2px rgba(0,0,0,0.05);
            "><img src="https://authjs.dev/img/providers/google.svg" width="20" height="20" style="margin-right:10px;vertical-align:middle;display:inline-block;" alt="Google" /> Continue with Google</a>"""
            try:
                st.html(google_html)
            except AttributeError:
        ...
        if "error" in gh_oauth:
            ...
            gh_html = f"""<a href="{gh_oauth['url']}" target="_self" style="
                ...
                border:1px solid #24292e; border-radius:6px;
                text-decoration:none; font-size:0.95rem; font-weight:500;
                margin-top:4px; box-sizing:border-box; box-shadow: 0 1px 2px rgba(0,0,0,0.05);
            "><img src="https://authjs.dev/img/providers/github.svg" width="20" height="20" style="margin-right:10px;vertical-align:middle;display:inline-block;filter:invert(1);" alt="GitHub" /> Continue with GitHub</a>"""
            try:
                st.html(gh_html)
            except AttributeError:
